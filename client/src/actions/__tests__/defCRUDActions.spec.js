...
describe('defibrillator CRUD actions', () => {
	...
	it(`should create action to ${types.CREATE_DEF_POINT}`, () => {
		...
		expect(actions.createDefPoint(mockNewDefInfo)).toEqual(expectedAction);
	});
	...
	it(`should create action to ${types.DELETE_DEF_POINT}`, () => {
		...
		expect(actions.deleteDefPoint(uniqueId)).toEqual(expectedAction);
	});
	...
	it(`should create action to ${types.EDIT_DEF_POINT}`, () => {
		...
		expect(actions.editDefPoint(mockNewDefInfo.id, mockNewDefInfo)).toEqual(expectedAction);
	});
