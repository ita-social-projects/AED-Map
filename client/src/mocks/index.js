...
},
{
	"id": "423432fsd4",
	"city": "Львів",
	"address": "вул. Любінська, 168, AED #1 ЛЬВІВСЬКИЙ МІЖНАРОДНИЙ АЕРОПОРТ",
	"cabinet": "Вхід в крайні ліві розсувні двері (ліворуч та прямо) 1 пов. Біля каб. Медпункту (на стіні)",
	"lang": "Україномовний",
	"accesibility": "Цілодобово. Без вихідних",
...
},
{
	"id": "576uyjty",
	"city": "Львів",
	"address": "вул. Єфремова 85 (вхід з вул. Конотопська) Медичний центр 'ПРОФІДЕНТ- ПЛЮС'",
	"cabinet": "1 пов. Рецепція (схований від загального виду/треба запитатись)",
	"lang": "Російськомовний",
...
export const mockNewDefInfo = {
	'id': '576uyjty',
	'city': 'Львів 2',
	'address': 'вул. Єфремова 131 (вхід з вул. Конотопська) Медичний центр \'ПРОФІДЕНТ- ПЛЮС\'',
	'cabinet': '1 пов. Рецепція (схований від загального виду/треба запитатись)',
	'lang': 'Російськомовний',
	'accesibility': 'Пн-Пт 09:00 - 18:00',
	'infoTableAboutAED': 'Немає',
